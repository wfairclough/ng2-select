...
export class SelectComponent implements OnInit, ControlValueAccessor {
  ...
  @Input() public attachTo?: string = undefined;
  ...
  behavior?: OptionsBehavior = undefined;
  inputValue: string = '';
  ...
  selectMatch(value: SelectItem, e?: Event): void {
    if (e) {
      e.stopPropagation();
      e.preventDefault();
    }
...
export class Behavior {
  ...
  public ensureHighlightVisible(optionsMap?: Map<string, number>): void {
  ...
  private getActiveIndex(optionsMap?: Map<string, number>): number {
